...
table2 <- getpower.exp.matching.opt(nSim=500, N=400,ratios=c(0.25,0.333,0.5,1,2,3,4,5),duration=24,
...
table3 <- getpower.exp.matching.opt(nSim=500, N=400,ratios=c(0.25,0.333,0.5,1,2,3,4,5),duration=24,
...
table4 <- getpower.exp.matching.opt(nSim=500, N=700,ratios=c(0.25,0.333,0.5,1,2,3,4,5),duration=24,
                                    med.TTE.Control=24,rho=1,med.TimeToCensor=14,beta=0.7, exp.prop=0.5,
                                    type="fixed",scenario="opt_exp_matching", method="marginal",
                                    prop.fullexp=0,maxrelexptime=1/6,min.futime=4,min.postexp.futime=4,
                                    simu.plot=FALSE) 
