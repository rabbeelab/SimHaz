...
for(i in c('marginal','strata')){
    table1 <- rbind(table1,getpower.exp.matching(nSim=5, N_match=100,duration=24,med.TTE.Control=24,rho=1, med.TimeToCensor=14, beta=0.7,matching.ratio=3,type="td", scenario="exposure_matching",  method=i, prop.fullexp=0,maxrelexptime=1,min.futime=0, min.postexp.futime=0,simu.plot=FALSE))
}
```
```{r,echo=F}
...
table3 <- getpower.exp.matching.opt(nSim=500, N=400,ratios=c(1,0.25,0.333,0.5,2,3,4,5),duration=24,
                                    med.TTE.Control=24,rho=1,med.TimeToCensor=14,beta=0.7, exp.prop=0.5,
                                    type="fixed",scenario="opt_exp_matching", method="marginal", 
                                    prop.fullexp=0,maxrelexptime=1/6,min.futime=4,min.postexp.futime=4,
                                    simu.plot=FALSE) 


table4 <- getpower.exp.matching.opt(nSim=500, N=700,ratios=c(1,0.25,0.333,0.5,2,3,4,5),duration=24,
                                    med.TTE.Control=24,rho=1,med.TimeToCensor=14,beta=0.7, exp.prop=0.5,
                                    type="fixed",scenario="opt_exp_matching", method="marginal",
                                    prop.fullexp=0,maxrelexptime=1/6,min.futime=4,min.postexp.futime=4,
                                    simu.plot=FALSE) 
...
table2 <- getpower.exp.matching.opt(nSim=5, N=400,ratios=c(1,0.25,0.333,0.5,2,3,4,5),
...
```{r,eval=F}
table3 <- getpower.exp.matching.opt(nSim=5, N=400,ratios=c(1,0.25,0.333,0.5,2,3,4,5),
                                    duration=24,med.TTE.Control=24,rho=1,
...
table4 <- getpower.exp.matching.opt(nSim=5, N=700,ratios=c(1,0.25,0.333,0.5,2,3,4,5),
                                    duration=24,med.TTE.Control=24,rho=1,
                                    med.TimeToCensor=14, beta=0.7, exp.prop=0.5, 
                                    type="fixed", scenario="opt_exp_matching",
                                    method="marginal", prop.fullexp=0, maxrelexptime=1/6,
