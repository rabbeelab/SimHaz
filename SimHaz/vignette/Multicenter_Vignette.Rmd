...
print(xtable(final1, caption = "Table 1: Equal Event Rates",,digits=c(0,0,0,0,5,3)), comment=F, hline.after = c(-1,0,3,6,9,12,15), booktabs=T,include.rownames = FALSE)
```
...
print(xtable(final3, caption = "Table 3: Gamma Centered Event Rates",digits=c(0,0,0,0,5,3)), comment=F, hline.after = c(-1,0,2,4,6,8,10), booktabs=T,include.rownames = FALSE)
...
In this scenario, the frailty model is recommended over the stratified model since we used gamma frailty to generate the data and center effects. 
